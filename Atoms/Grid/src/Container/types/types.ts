 ...
 *  Типы display css
 */
 export type Display = 'block' | 'inline' | 'inline-block' | 'inline-grid' | 'flex' | 'grid';

/**
 * Выравнивание flex елементов по горизонтали
 */
 export type AlignHorizon = 'start' | 'end' | 'center' | 'between' | 'around';


/**
 * Выравнивание flex елементов по вертикали
 */
 export type AlignVertically = 'start' | 'end' | 'center' | 'stretch' | 'baseline';
